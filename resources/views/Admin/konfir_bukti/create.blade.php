...
@section('title', 'Tambah Bukti Tantangan')
...
<div class="relative flex-1 lg:ml-64 transition-all duration-300 p-6 bg-gray-100 top-0 bottom-0 border-l-8 border-[#ddd] lg:border-l-8 max-lg:border-l-0">
    ...
    <div class="flex justify-between items-center mb-8"> 
        <div class="mb-8">
            <h1 class="lg:text-2xl font-bold text-gray-800 -mt-5 pt-5 hidden md:block">Tambah Bukti Tantangan</h1>
        </div>
    ...
    <div class=" mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <form action="{{ route('Admin.konfir_bukti.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" name="challenge_id" class="w-full border rounded px-3 py-2" required>
            </div>

            <div class="mb-4">
                <label class="block font-medium mb-1">Upload Bukti</label>
                <input type="file" name="file_path" class="w-full border rounded px-3 py-2" required>
            </div>
