...
<div class="relative flex-1 lg:ml-64 transition-all duration-300 p-6 bg-gray-100 top-0 bottom-0 border-l-8 border-[#ddd] lg:border-l-8 max-lg:border-l-0">
    ...
    <div class="flex justify-between items-center mb-8"> 
        <div class="mb-8">
            <h1 class="lg:text-2xl font-bold text-gray-800 -mt-5 pt-5 hidden md:block">Tambah Olahraga</h1>
        </div>
...
<div class="mx-auto bg-white p-6 rounded-lg shadow-lg">
    <form action="{{ route('olahraga.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="kategori" class="w-full border rounded p-2" value="{{ old('kategori') }}" required>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">Durasi (menit)</label>
            <input type="number" name="durasi" class="w-full border rounded p-2" value="{{ old('durasi') }}" required>
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 font-semibold mb-2">URL Video</label>
            <input type="url" name="url_video" class="w-full border rounded p-2" value="{{ old('url_video') }}">
        </div>
