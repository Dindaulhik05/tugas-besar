...
class CekKesehatanController extends Controller
{
    ...
    {
        $userId = Auth::id();
        $bmiResults = BMIUser::where('user_id', Auth::id())->get();
        $bmrResults = BMRUser::where('user_id', Auth::id())->get();
        return view('kesehatan.index', compact('bmiResults', 'bmrResults'));
    }
    ...
    {
        $bmiResults = BMIUser::where('user_id', Auth::id())->get();
        return view('kesehatan.bmi', compact('bmiResults'));
    }
    ...
    {
        $bmrResults = BMRUser::where('user_id', Auth::id())->get();
        return view('kesehatan.bmr', compact('bmrResults'));
    }
